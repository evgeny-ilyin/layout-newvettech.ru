...
export function swipersInit() {
	...
	function getLoopOption(container, className = 'is-single') {
		...
		return slides.length > 4; // loop включаем только если слайдов больше четырех. если слайдов меньше, неправильно работает порядок и первый становится последним
	}
